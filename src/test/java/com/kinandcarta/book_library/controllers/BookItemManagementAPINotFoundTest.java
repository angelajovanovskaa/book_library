...
class BookItemManagementAPINotFoundTest {
    ...
    @Test
    void insertBookItem_bookItemDoesNotExist_returnsNotFound() throws Exception {
        // given
    ...
    void deleteBookItem_bookItemDoesNotExist_returnsNotFound() throws Exception {
        // given
        final String deleteBookItemPath = DELETE_BOOK_ITEM_PATH + BookItemTestData.BOOK_ITEM_ID;
    ...
    void reportBookItemAsDamaged_bookItemDoesNotExist_returnsNotFound() throws Exception {
        // given
        final String reportBookItemPathAsDamaged = REPORT_BOOK_ITEM_AS_DAMAGED + BookItemTestData.BOOK_ITEM_ID;
    ...
    void reportBookItemAsLost_bookItemDoesNotExist_returnsNotFound() throws Exception {
        // given
        final String reportBookItemPathAsLost = REPORT_BOOK_ITEM_AS_LOST + BookItemTestData.BOOK_ITEM_ID;
