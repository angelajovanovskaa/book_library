...
//
//        given(reviewRepository.findAllByBookIsbnAndBookOfficeName(isbn, officeName)).willReturn(reviews);
//        given(reviewConverter.toReviewResponseDTO(any())).willReturn(reviewResponseDTOS.get(0),
//                reviewResponseDTOS.get(1));
//
//        // when
//        List<ReviewResponseDTO> actualResult = reviewQueryService.getAllReviewsByBookIsbnAndByOfficeName(isbn, officeName);
//
//        // then
//        verify(reviewRepository).findAllByBookIsbnAndBookOfficeName(isbn, officeName);
