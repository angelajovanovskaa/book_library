...
//        given(reviewRepository.findAllByBookIsbnAndBookOfficeName(reviewRequestDTO.bookISBN())).willReturn(
...
//        given(reviewRepository.findAllByBookIsbnAndBookOfficeName(any())).willReturn(Collections.singletonList(review));
...
//        verify(reviewRepository).findAllByBookIsbnAndBookOfficeName(any());
...
//        given(reviewRepository.findAllByBookIsbnAndBookOfficeName(book.getIsbn())).willReturn(
//                Collections.singletonList(review));
//        given(calculateAverageRatingOnBook.getAverageRatingOnBook(Collections.singletonList(review.getRating())))
//                .willReturn(4.0);
//
