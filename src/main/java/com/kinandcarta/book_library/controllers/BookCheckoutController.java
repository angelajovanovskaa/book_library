...
public class BookCheckoutController {
    ...
    @GetMapping("/get-all-near-return-date")
    ...
    @GetMapping("/get-all-by-title-containing")
    ...
    @GetMapping("/get-all-books-for-user")
    ...
    @GetMapping("/get-all-books-for-user-by-title-containing")
